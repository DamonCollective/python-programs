#!/usr/bin/env python3
"""
Fix Daphne (139-141): Φουντωτή → Σγουρή in product[header][name][2]
"""
...
def update_product(s, cat_tok, pid):
    ...
    try:
        ...
        # Fix the EL product name (correct field path)
        payload['product[header][name][2]'] = EL_NAMES[pid]
...
log(f'Fixing EL product names for {len(EL_NAMES)} Daphne products.\n')
