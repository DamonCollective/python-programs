"""
Batch set online_only=0 (available in both online + physical store) for all products.
Also preserves: visibility='both', delivery_time_note_type='1'.
"""
...
EXCLUDE = {
    ...
    'product[options][visibility][visibility]',   # set explicitly
    'product[options][visibility][online_only]',  # set explicitly
}
...
log(f'Found {len(pids)} products. Setting online_only=0 (online + physical store)...\n')
